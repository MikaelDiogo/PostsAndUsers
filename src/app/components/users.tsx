...
async function UsersAPI(){
    ...
    return(
      ...
      <div className=" ml-24">
        <a href="/users"><button className=" flex justify-center items-center w-28 py-1 rounded-lg mt-4  text-zinc-50 font-semibold text-center bg-zinc-800 hover:bg-zinc-900 ">See Users</button>
</a>
      </div>
